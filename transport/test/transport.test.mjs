...
import { credentials } from '../../apps/ssh.mjs';
import { connectSSH, runCommand } from '../../apps/ssh-client.mjs';
import { startSSHFixture } from '../../apps/test/ssh-fixture.mjs';
import { copyFiles } from '../../apps/sftp.mjs';
...
before(async () => {
  ...
  execFileSync('go', ['build', '-o', join(dir, 'fixture'), './test/fixture'], { cwd: root + 'transport/go', env: { ...process.env, GOTOOLCHAIN: 'go1.27.1' }, stdio: 'pipe' });
